...
# )
data = dict(
    image_size = 1024, aesthetic_score=4.0, batch_size=16, workers=2, threads=4,
    load_vae_feat=False, load_t5_feat=False
)
image_size = 1024
...
load_from = None
resume_from = None
vae_pretrained = "/sensei-fs/users/hyou/ckpts/pretrained_models/pixart_sigma_sdxlvae_T5_diffusers/vae"  # sdxl vae
