...
class GaussianDiffusion:
    ...
    def p_sample_loop(
        ...
        for sample in self.p_sample_loop_progressive(
            ...
            final = sample
            stats["latency"].append(sample["extra"]["latency"])
            stats["memory"].append(sample["extra"]["memory"])
        return final["sample"], stats
    ...
    @th.inference_mode()
    def validation_losses(self, accelerator, model, x_start, timestep, model_kwargs=None, noise=None, skip_noise=False):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            model_output, mod_loss, _ = model(x_t, t, **model_kwargs)
            terms["mod"] = mod_loss
            ...
            terms["loss"] = terms["loss"] + self.alpha * terms["mod"]

            # if self.training_ite % 2000 == 0 and self.training_ite != 0:
            #     self.alpha -= 1
    ...
    def training_losses(self, model, x_start, timestep, model_kwargs=None, noise=None, skip_noise=False):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            # if self.training_ite % 3000 == 0 and self.training_ite != 0:
            #     self.alpha -= 1
